...
![ecs logo](https://github.com/crancurello/containers_aws/blob/master/03-DeployEcsCluster/images/ecs_logo.png)

**Quick jump:**

* [1. Tutorial overview](https://github.com/crancurello/containers_aws/tree/master/03-DeployEcsCluster#tutorial-overview)
* [2. Creating the Cluster](https://github.com/crancurello/containers_aws/tree/master/03-DeployEcsCluster#creating-the-cluster)
* [3. Creating the ALB](https://github.com/crancurello/containers_aws/tree/master/03-DeployEcsCluster#creating-the-alb)
* [4. Creating the Task Definition](https://github.com/crancurello/containers_aws/tree/master/03-DeployEcsCluster#creating-the-task-definition)
* [5. Creating the Service](https://github.com/crancurello/containers_aws/tree/master/03-DeployEcsCluster#creating-the-service)
* [6. Testing our service deployments from the console and the ALB](https://github.com/crancurello/containers_aws/tree/master/03-DeployEcsCluster#testing-our-service-deployments-from-the-console-and-the-alb)
* [7. More in-depth logging with Cloudwatch](https://github.com/crancurello/containers_aws/tree/master/03-DeployEcsCluster#more-in-depth-logging-with-cloudwatch)
* [8. That's a wrap!](https://github.com/crancurello/containers_aws/tree/master/03-DeployEcsCluster#thats-a-wrap)
...
* [Setup Environment](https://github.com/crancurello/containers_aws/tree/master/01-SetupEnvironment)
* [Creating your Docker image](https://github.com/crancurello/containers_aws/tree/master/02-CreatingDockerImage)
...
![choose ALB](https://github.com/crancurello/containers_aws/blob/master/03-DeployEcsCluster/images/select_alb.png)

Name your ALB **lts-workshop** and add an HTTP listener on port 80:

![name ALB](https://github.com/crancurello/containers_aws/blob/master/03-DeployEcsCluster/images/create_alb.png)
...
![add VPC](https://github.com/crancurello/containers_aws/blob/master/03-DeployEcsCluster/images/configure_alb.png)
...
![create alb security group](https://github.com/crancurello/containers_aws/blob/master/03-DeployEcsCluster/images/create_alb_sg.png)
...
![add routing](https://github.com/crancurello/containers_aws/blob/master/03-DeployEcsCluster/images/configure_alb_routing.png)
...
![ec2 sg configuration](https://github.com/crancurello/containers_aws/blob/master/03-DeployEcsCluster/images/ec2_sg_configuration.png)
...
![type compatibility](https://github.com/crancurello/containers_aws/blob/master/03-DeployEcsCluster/images/task_compatibility.png)

And them click in **Next Step**. Name your task **lts-demo-app**:

![create task def](https://github.com/crancurello/containers_aws/blob/master/03-DeployEcsCluster/images/create_task_def.png)
...
![container def](https://github.com/crancurello/containers_aws/blob/master/03-DeployEcsCluster/images/container_def.png)
...
![aws log driver](https://github.com/crancurello/containers_aws/blob/master/03-DeployEcsCluster/images/setup_logdriver.png)
...
Navigate back to the ECS console, and choose the cluster that you created during the first run wizard.  This should be named **lts-workshop**.  If you don't have a cluster named **lts-workshop**, create one following the procedures in  [Creating the cluster](https://github.com/crancurello/containers_aws/tree/master/03-DeployEcsCluster#creating-the-cluster).
...
![create service](https://github.com/crancurello/containers_aws/blob/master/03-DeployEcsCluster/images/create_service.png)
...
![add to ALB](https://github.com/crancurello/containers_aws/blob/master/03-DeployEcsCluster/images/add_container_to_alb.png)
...
![configure container ALB](https://github.com/crancurello/containers_aws/blob/master/03-DeployEcsCluster/images/configure_container_alb.png)
...
![deployment event](https://github.com/crancurello/containers_aws/blob/master/03-DeployEcsCluster/images/steady_state_service.png)
...
![alb web test](https://github.com/crancurello/containers_aws/blob/master/03-DeployEcsCluster/images/alb_app_response.png)
...
![log group](https://github.com/crancurello/containers_aws/blob/master/03-DeployEcsCluster/images/loggroup.png)

And then choosing an individual stream:

![event streams](https://github.com/crancurello/containers_aws/blob/master/03-DeployEcsCluster/images/event_streams.png)
